...
enum BotMarkPersona: String, CaseIterable, Identifiable, Sendable {
    ...
    var title: String {
        switch self {
        case .calm: L10n.t("Calm")
        case .eager: L10n.t("Eager")
        case .steady: L10n.t("Steady")
        case .curious: L10n.t("Curious")
        case .sleepy: L10n.t("Sleepy")
        case .playful: L10n.t("Playful")
        case .stoic: L10n.t("Stoic")
        case .proud: L10n.t("Proud")
        }
    }
