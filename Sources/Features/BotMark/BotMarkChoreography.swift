/**
 @name: 机器人动作编排
 @Descripttion: 定义八种性格的顺序动作、节奏及完成反馈。
 @version: 1.0.0
 @Author: sm
 @Date: 2026-09-20 10:28:47
 @LastEditTime: 2026-09-20 10:28:47
 @FilePath: Sources/Features/BotMark/BotMarkChoreography.swift
 */
...
struct BotMarkChoreography: Sendable {
    ...
    init(idle: BotMarkRoutine, working: BotMarkRoutine, fetching: BotMarkRoutine,
         spent: BotMarkRoutine, attention: BotMarkRoutine,
         completion: String) {
        self.idle = idle
    ...
    static let sleep = BotMarkRoutine(.init("sleeping", 6_000...8_000))
