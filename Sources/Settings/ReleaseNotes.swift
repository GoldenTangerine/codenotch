...
enum ReleaseNotes {
    static let all: [ReleaseNote] = [
        ReleaseNote(
            version: "1.6.0",
            headline: "More displays, providers and alerts, with your custom queries preserved.",
            changes: [
                ReleaseNote.Change(
                    title: "Your custom providers stay with you",
                    detail: "Keep multiple accounts, manual credentials, query scripts, language settings and Code Switch R integration. Existing configurations can add Copilot and Gemini API from Add provider."
                ),
                ReleaseNote.Change(
                    title: "Drag to reorder the rings",
                    detail: "Settings keeps your configured providers and accounts; "
                          + "drag a provider row by its handle to change the "
