...
actor ClaudeOAuthProvider: UsageProvider {
    ...
    nonisolated var signInRoute: SignInRoute {
        ...
        .guidance(String(localized: "Run `\(profile.signInCommand)` once — it signs in and is what these readings come from. Use /login there to change account."))
    }
...
struct UsageResponse: Decodable {
    ...
    func limitWindows() -> [LimitWindow] {
        ...
        merge(fiveHour, id: "session", label: String(localized: "Current session"))
        merge(sevenDay, id: "weekly_all", label: String(localized: "All models"))
    ...
    static func label(forKind kind: String) -> String {
        ...
        case "weekly_all":    return String(localized: "All models")
        // Model names — the vendor's own words, left as they are.
